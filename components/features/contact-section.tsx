      ...
      <Container>
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Solicite seu orçamento gratuitamente pelo WhatsApp
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
            ...
            <p className="text-gray-600">Seg - Sáb: 8h às 18h</p>
          </div>
        </div>
        ...
        <div className="text-center mt-12">
          <Link
            ...
            target="_blank"
            className="inline-flex items-center gap-3 bg-green-500 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-green-600 transition-all shadow-lg hover:shadow-xl"
          >
